...
const Template11 = forwardRef((props, ref) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-gray-50 border border-gray-300 rounded-lg">
      ...
      <section className="grid grid-cols-2 gap-8 mb-8">
        ...
        <div>
          <h2 className="text-sm font-bold text-gray-600">YOUR COMPANY NAME</h2>
          <p className="text-sm text-gray-700">
      ...
      <section className="grid grid-cols-2 gap-8 mb-8">
        <div>
          ...
          <p className="text-sm text-gray-700">00001</p>
        </div>
        <div>
          <h2 className="text-sm font-bold text-gray-600">DATE OF ISSUE</h2>
          <p className="text-sm text-gray-700">MM/DD/YYYY</p>
        </div>
      </section>
